...
## Results: 
- **VADER (lexicon)** — Accuracy: 61.10%. 
- **MultinomialNB** — Accuracy: 73.47% (→ GridSearchCV → 74.20%). 
- **LinearSVC** — Accuracy: 76.52% (→ GridSearchCV → 77.22%). 
- **Logistic Regression** — Accuracy: 76.62% (→ GridSearchCV → 77.21%). 
- **Voting Classifier (ensemble)** — Final Accuracy: 77.18%. 
